...
<style>
	...
	#dropbox {float:left; width:150px;}
				...
				<div class="col-12">
					<div class="card">
						...
						<div class="card-tools">
								<div class="input-group input-group-sm" style="width: auto" id="searchUI">
									<!-- 드롭박스 -->
									<div class="col-12">
										<div id="dropbox">
											...
											<button type="submit" class="btn btn-default" id="searchBtn" style="display: inline-block">
	...
	<div class="modal-dialog modal-dialog-scrollable modal-xl">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">출퇴근 허용 IP설정</h5>
...
<script type="text/javascript">
	...
	var dept_nameTag = $("select[name='dept_code']").data(
			"success",
			function(resp) {
				var html = optionPtrn.replace("%V", '').replace("%T", '전체부서');
