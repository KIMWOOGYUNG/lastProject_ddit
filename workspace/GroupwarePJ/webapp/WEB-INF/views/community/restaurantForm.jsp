		...
		<div class="card card-info">
			...
			<form role="board">
				...
				<br><br>
					...
					<c:if test = "${not empty board.board_code }">
						<button type="submit" class="btn btn-primary" id="save" style="margin-left: 50%"><i class="fas fa-pencil-alt"> </i> 수정</button>
					</c:if>
