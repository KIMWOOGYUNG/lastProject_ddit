...
<div id="content">
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				...
				<div class="input-group input-group-sm" id="searchUI"
					...
					<select name="searchType" class="custom-select">
						<option value="name"
							${pagingVO.searchVO.searchType eq 'name'?"selected":"" }>이름</option>
						<option value="dept"
							${paginVO.searchVO.searchType eq 'department'?"selected":"" }>소속</option>
			...
			<!-- 아이콘 -->
			<div>
				<button class="button showBtn" id="blockBtn"
					data-target="#blockBody">
			...
			<div class="card-body">
				<a class="btn btn-primary btn-sm" id="insertBtn"> <i
					class="fas fa-folder"> </i> 등록
				</a> <a class="btn btn-danger btn-sm" id="delBtn" href="#"
					onclick="deleteAction()"> <i class="fas fa-trash"> </i> 삭제
				</a>
...
<div id="blockBody" class="toggleShow" style="height: 850px;"></div>
<div id="footer">
