...
<form:form id="deptscheduleForm" modelAttribute="deptschedule" method="post" enctype="multipart/form-data" class="w-100"
			action="${pageContext.request.contextPath }/plan/detaildepplan/${deptschedule.ds_code}/dsmodify">
              ...
              <form class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="hidden" class="form-control" id="writer" value="${deptschedule.writer}" name="writer" readonly="readonly">
                    <p class="form-control" style="margin: 0; width: 200px;">${deptschedule.writer_name}</p>
                    </div>
                  </div>
...
<!-- 				</div> -->
				...
				<input type="text" class="form-control"  id="emp_kors" name="" value="${deptschedule.manager_name }" style="height: 35px; width: 200px; border: 1px solid #ced4da; border-radius: .25rem;">
				<!-- 주소록 버튼 -->
				<button type="button" class="btn btn-secondary" id="btnAddEmp" data-toggle="modal" data-target="#modal-lg">
					<i class="fas fa-users"></i>
				</button>
				</div>
				<input type="hidden" id="receiver_code" name="manager"/>
