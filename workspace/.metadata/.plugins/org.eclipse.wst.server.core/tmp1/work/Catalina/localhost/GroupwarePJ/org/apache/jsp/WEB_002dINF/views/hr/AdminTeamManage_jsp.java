 ...
 * Generated at: 2020-08-11 02:57:24 UTC
...
public final class AdminTeamManage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t   <th rowspan=\"1\" colspan=\"1\">팀코드</th>\r\n");
      ...
      out.write("\t\t\t\tlet teamList = resp.dataList;\r\n");
      out.write("\t\t\t\tlet pagingHTML = resp.pagingHTML;\r\n");
      out.write("\t\t\t\tlet trTags = [];\r\n");
      out.write("\t\t\t\tif(teamList.length>0){\r\n");
      out.write("\t\t\t\t\t$.each(teamList, function(idx, teammanage){\r\n");
      out.write("\t\t\t\t\t\tlet trTag = $(\"<tr>\").append(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$(\"<td>\").html('<input type=\"checkbox\" name=\"checkRow\" value=\"'+teammanage.team_code+'\" />')\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").text(teammanage.team_code)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").text(teammanage.team_name)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t);\r\n");
      out.write("\t\t\t\t\t\ttrTags.push(trTag);\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t$(\"#pagingArea\").html(pagingHTML);\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\ttrTags.push($(\"<tr>\").html($(\"<td colspan='8'>\").text(\"조건에 맞는 팀이 없음.\")));\r\n");
      ...
      out.write("\t    alert(\"삭제할 팀을 선택하세요.\");\r\n");
      out.write("\t    return false;\r\n");
      out.write("\t  }\r\n");
      out.write("\t  console.log(\"### checkRow => {}\"+checkRow);\r\n");
      out.write("\t \r\n");
      out.write("\t  if(confirm(\"팀을 삭제 하시겠습니까?\")){\r\n");
      out.write("\t\t  $.ajax({\r\n");
      out.write("\t            url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/hr/employer/deleteteam',\r\n");
      out.write("\t            type : \"POST\",\r\n");
      out.write("\t            datatype : 'json',\r\n");
      out.write("\t            contentType: \"application/x-www-form-urlencoded; charset=UTF-8\", \r\n");
      out.write("\t            data:{\r\n");
      out.write("\t                team_code : checkRow\r\n");
      out.write("\t            },\r\n");
