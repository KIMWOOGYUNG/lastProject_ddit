...
///팀 리스트 조회 
	...
	//쪽지쓰기 화면이동
		@GetMapping("/note/writenote/{emp_code}")
		public String writenote(@PathVariable String emp_code, RedirectAttributes attributes) {
				EmployeeVO empVO = new EmployeeVO();
				empVO.setEmp_code(emp_code);
				empVO =IloginService.getEmpInfo(empVO);
				
				attributes.addFlashAttribute("emp_code",emp_code);
				attributes.addFlashAttribute("emp_receiver", empVO.getEmp_kor());
				attributes.addFlashAttribute("position_name", empVO.getPosition_name());
			return "redirect:/note/writenote";
