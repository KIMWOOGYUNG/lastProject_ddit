...
public interface IApprovalDAO {
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////
	String selectAppringInfo(String draft_code);
	String selectInsteadInfo(DraftVO draftVO);
	...
	int deleteComment(String cmt_code);
	List<CommentVO> selectCommentList(String draft_code);
	CommentVO selectCommentInfo(String cmt_code);
	///////////////
	
	String selectApprCheck(Appr_StatVO appr_StatVO);
	List<String> selectWorkedDateList(Map<String, String> sendData);
	int insertVacation(VacationVO vacationVO);
	int deleteVacation(String draft_code);
	int insertInsteadInfo(Instead_AuthVO authVO);
	int deleteInsteadInfo(String draft_code);
	int updateInsteadInfo(String dratf_code);
	int updateVacation(String dratf_code);
	List<VacationVO> selectVactionList(String draft_code);
	List<StandardVO> selectVacationInfo();
