...
<style>
	...
	#nav{float:right;width:200px;margin-top:10px;}
	...
	<div class="col-12">
		<div class="card">
			...
			<div class="card-body table-responsive p-0">
				<table class="table table-hover text-nowrap toggleShow" id="taskTable" >
					<thead>
				        <tr>
				        	<th>
				        	<c:if test="${whoseTask  eq 'myTask'}">
				...
				if(taskList.length>0){                 
					$.each(taskList, function(idx, task){
						...
						let trTag = $("<tr>").append(
								...
								, $("<td class='project-state text-center'>").text(task.task_change)
						);
						trTags.push(trTag);
					});
