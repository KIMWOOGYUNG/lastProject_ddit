...
<form:form id="deptscheduleForm" modelAttribute="deptschedule" method="post" enctype="multipart/form-data" class="w-100"
			action="${pageContext.request.contextPath }/plan/DetailMySchedule/${myschedule.ms_code}/msmodify">
              ...
              <form class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="emp_code" value="${myschedule.emp_code}" name="emp_code" readonly="readonly" style="width: 200px; background-color: white;">
                    </div>
                  </div>
...
<!--                   <button type="submit" class="btn btn-info">확인</button> -->
                    <a class="btn btn-info" href="${cPath}/plan/myplanbox/myplan">  
					확인
					</a>
