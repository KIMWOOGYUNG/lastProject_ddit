...
<div class="col-12">
            <div class="card">
              <div class="card-header">
                <h2>공유일일업무일지</h2>
               <div id="nav">
			   <button id = "myteam" type = "button" class="btn btn-primary btn-sm">내팀보기</button>
			   </div>
...
<form id="searchForm" action="${cPath }/work/publicwork/daydiary/${team_code==null?'all' : team_code}">
...
<script type="text/javascript">
	...
	$("#myteam").on("click", function(){
		 location.href = "${cPath}/work/publicwork/daydiary/${authUser.team_code }";
	});
