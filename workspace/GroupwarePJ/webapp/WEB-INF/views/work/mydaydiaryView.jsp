...
<div class = "content row" style="padding:30px 50px;">
	<div class="card card-primary col-sm-12" >
		...
		<div id = "top" style="width:80%;margin:0 auto; padding:0 10px;">
			...
			<button class="btn btn-info btn-sm float-sm-right" id="updateBtn" style="margin:5px;">
		...
		<div class="card card-primary" style="width: 77%; margin:0 auto;">
			...
			<div class="card-body" style="display: block;">
				<c:forEach items="${worklog.attatchList }" var="attatch" varStatus="vs">
					<a href="<c:url value='/work/file/${attatch.wl_attcode }'/>">${attatch.org_name } </a>${not vs.last?"&nbsp;":"" }
				</c:forEach>
			</div>
			<!-- /.card-body -->
		</div>
		...
		<div id="pdfchange" style="width:100%;padding-bottom:100px;">
		    <table id="pdftable" border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0" style="width:80%;margin:0 auto;">
		        ...
		        <tbody>
		          ...
		          <tr class="row1">
		            <td class="column0">&nbsp;</td>
		            <c:if test="${worklog.wl_catag eq 'WLC100' }">
		            <td class="column1 style24 s style69" colspan="18" rowspan="5">&nbsp;일일 업무 일지</td>
		            </c:if>
		            <c:if test="${worklog.wl_catag eq 'WLC200' or worklog.wl_team eq 'Y'}">
		            <td class="column1 style24 s style69" colspan="18" rowspan="5">&nbsp;주간 업무 일지</td>
		            </c:if>
		          ...
		          <tr class="row2">
		            <td class="column0">&nbsp;</td>
		            <td class="column19 style10 null style18" colspan="3" rowspan="3"><c:if test="${worklog.emp_attcode ne null}"><img src="${cPath }/emp/file/${worklog.emp_attcode }" style="height: 100px; width: 100px;"> </c:if></td>
		            <td class="column22 style10 null style21" colspan="3" rowspan="3"></td>
		          </tr>
		          <tr class="row3">
		            <td class="column0">&nbsp;</td>
		          </tr>
		          ...
		          <tr class="row5">
		            ...
		            <td class="column21 style9 null style31" colspan="4">${worklog.emp_kor }</td>
		          </tr>
		          <tr class="row6">
		            <td class="column0">&nbsp;</td>
		          ...
		          <tr class="row7">
		            ...
		            <td class="column4 style34 null style36" colspan="11" rowspan="2">${worklog.team_code }</td>
		            <td class="column15 style37 s style23" colspan="2" rowspan="2">작성일자</td>
		            <td class="column17 style34 null style39" colspan="8" rowspan="2">${worklog.wl_date }</td>
		          </tr>
		          <tr class="row8">
		            <td class="column0">&nbsp;</td>
		          </tr>
		          ...
		          <tr class="row10">
		            ...
		            <td class="column4 style49 null style50" colspan="21">${worklog.wl_title }</td>
		          </tr>
		          <tr class="row11">
		            <td class="column0">&nbsp;</td>
		            <td class="column1 style40 s style53" colspan="3" rowspan="27">진행 업무    내용</td>
		            <td class="column4 style54 null style62" colspan="21" rowspan="27">${worklog.wl_content }</td>
		          </tr>
		          <tr class="row12">
		            <td class="column0">&nbsp;</td>
		          </tr>
...
<script>
	$("#updateBtn").on("click", function(){
		location.href = "${cPath}/work/mywork/mydiaryForm/${worklog.wl_code}/${worklog.wl_catag}"
	});
