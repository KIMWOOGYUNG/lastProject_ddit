...
<div  class="card-body table-responsive p-0">
		...
		<button class="button showBtn" id="blockBtn" data-target="#blockBody" onclick = "location.href = '${cPath}/plan/myplancalendar/all' ">
...
//전체 선택
	...
	function deleteAction(){
	  ...
	  if(confirm("일정을 삭제 하시겠습니까?")){
		  $.ajax({
	            url : '${pageContext.request.contextPath }/plan/myplanbox/myplan/deletemy',
	            type : "POST",
	            datatype : 'json',
	            ...
	            success : function(data) {
				    alert("삭제가 완료되었습니다.");
				    location.href="${pageContext.request.contextPath }/plan/myplanbox/myplan";
