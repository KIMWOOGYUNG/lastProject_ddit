...
<!--  <form class="form-horizontal"> -->
            ...
            <div class="card card-info">
              ...
              <img src="${cPath }/approval/download/emp/${address.emp_attcode}" class="img-fluid mb-2" 
              ...
              <form class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" readonly="readonly" style="height: 35px; width: 200px;" value="${address.emp_code}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputEmail3" readonly="readonly" style="height: 35px; width: 200px;" value="${address.emp_kor}">
                    </div>
                  </div>
				...
				<div class="col-sm-10">
						<input type="text" class="form-control" id="inputEmail3" value="${address.jobtitle_code eq null ? '없음' : address.jobtitle_code }" readonly="readonly"  style="height: 35px; width: 200px;" >	
				</div>
			</div>
			 ...
			 <div class="form-group row">
				...
				<div class="col-sm-10">
						<input type="text" class="form-control" id="inputEmail3" value="${address.position_code}" readonly="readonly" style="height: 35px; width: 200px;" >	
				</div>
			</div>
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                       <input type="text" class="form-control" id="inputEmail3" readonly="readonly" style="height: 35px; width: 200px;" value="${address.team_code}">
                    </div>
                  </div>
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="inputEmail3" value="${address.emp_mail}" readonly="readonly" style="height: 35px; width: 200px;" >	
				 <a href="${cPath}"></a>
				</div>
			</div> 
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="inputEmail3" value="${address.emp_hp}" readonly="readonly"  style="height: 35px; width: 200px;" >		
				</div>
			</div> 
			   ...
			   <div class="form-group row">
				...
				<div class="col-sm-10">
						<input type="text" class="form-control" id="inputEmail3" value="${address.co_phone}" readonly="readonly" style="height: 35px; width: 200px;" >	
				</div>
			</div> 
			</form>
			</div>
