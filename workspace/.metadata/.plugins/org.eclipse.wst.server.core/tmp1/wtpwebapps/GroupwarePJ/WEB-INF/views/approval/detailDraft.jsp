...
<c:if test="${draftVO.draft_stat eq 'APP006' or draftVO.draft_stat eq 'APP005' }">
    ...
    <form action="${cPath}/approval/approvalmodify/${draftVO.draft_code}" method="post"> 
	 	<button class="btn btn-info btn-sm" id="draftModfiyBtn">수정</button>
    </form>
    </c:if>
    </div>
  	...
  	<table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 m-auto" >
        ...
        <tbody>
          ...
          <tr class="row1">
            ...
            <td class="column1 style8 style10 content" colspan="35">${draftVO.draft_title}</td>
            <td class="column38">&nbsp;</td>
            <td class="column39">&nbsp;</td>
<!--             <td class="column40">&nbsp;</td> -->
<!--             <td class="column41">&nbsp;</td> -->
<!--             <td class="column42">&nbsp;</td> -->
            ...
            <td class="column42">&nbsp;</td>
             <td class="column43 style14 style15 style10 style11" colspan="2" rowspan="3"> 
            	<c:choose>
             		...
             		<c:when test="${ draftVO.apprList[0].empVO.position_name eq null}">
             			<img class="img-fluid" src="${cPath}/approval/download/att/AA999">
             		</c:when>
             		</c:choose>
             	</td>
             	<td class="column43 style14 style15 style10 style11" colspan="2" rowspan="3"> 
	            	<c:choose>
             		...
             		<c:when test="${ draftVO.apprList[1].empVO.position_name eq null}">
             			<img class="img-fluid" src="${cPath}/approval/download/att/AA999">
             		</c:when>
             		</c:choose>
             	</td>
             	<td class="column43 style14 style15 style10 style11" colspan="2" rowspan="3"> 
	            	<c:choose>
             		...
             		<c:when test="${ draftVO.apprList[2].empVO.position_name eq null}">
             			<img class="img-fluid" src="${cPath}/approval/download/att/AA999">
             		</c:when>
             		</c:choose>
             	</td>
             	<td class="column43 style14 style15 style10 style11" colspan="2" rowspan="3">
	             	<c:choose>
	             		...
	             		<c:when test="${ draftVO.apprList[3].empVO.position_name eq null}">
	             			<img class="img-fluid" src="${cPath}/approval/download/att/AA999">
	             		</c:when>
	             	</c:choose>
	             	</td>
             	<td class="column43 style14 style15 style10 style11" colspan="2" rowspan="3"> 
	             	<c:choose>
	             		...
	             		<c:when test="${ draftVO.apprList[4].empVO.position_name eq null}">
	             			<img class="img-fluid" src="${cPath}/approval/download/att/AA999">
	             		</c:when>
	             	</c:choose>
             	</td>
          ...
          <tr class="row3">
            ...
            <td class="column1 style8 style10 content" colspan="35">${draftVO.empVO.emp_kor}</td>
            <td class="column38">&nbsp;</td>
            <td class="column39">&nbsp;</td>
            <td class="column40">&nbsp;</td>
            <td class="column41">&nbsp;</td>
          ...
          <tr class="row4">
            ...
            <td class="column1 style8 style10 content" colspan="35">${draftVO.empVO.team_name}</td>
            <td class="column38">&nbsp;</td>
            <td class="column39">&nbsp;</td>
            <td class="column40">&nbsp;</td>
            <td class="column41">&nbsp;</td>
          ...
          <tr class="row5">
            ...
            <td class="column1 style8 style10 content" colspan="35">${fn:split(draftVO.draft_date,' ')[0] }</td>
           <td class="column38">&nbsp;</td>
            <td class="column39">&nbsp;</td>
<!--             <td class="column40">&nbsp;</td> -->
<!--             <td class="column41">&nbsp;</td> -->
...
<!--             <td class="column41">&nbsp;</td> -->
        ...
        <c:if test="${draftVO.rg1List ne null }">
          <tr class="row7">
            <td class="column0">&nbsp;</td>
            <td class="column1 style8 style10 title" colspan="6">참조자</td>
            <td class="column1 style8 style10 content" colspan="34">
          ...
          <tr class="row8">
            <td class="column0">&nbsp;</td>
           <td class="column1 style8 style10 title" colspan="6">열람권자</td>
            <td class="column1 style8 style10 content" colspan="34">
          ...
          <tr class="row9">
            <td class="column0">&nbsp;</td>
            <td class="column1 style8 style10 title" colspan="6">대결권자</td>
            <td class="column1 style8 style10 content" colspan="34">
          ...
          <tr class="row9">
            <td class="column0">&nbsp;</td>
            <td class="column1 style8 style10 title" colspan="6">휴가 종류</td>
            <td class="column1 style8 style10 content" colspan="34">
