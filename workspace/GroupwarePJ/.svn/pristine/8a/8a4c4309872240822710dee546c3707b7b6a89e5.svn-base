...
<!-- 				</div> -->
				...
				<div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="cs_title" value="${comschedule.cs_title}" name="cs_title" style="width: 400px;">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">작성자</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="emp_code" value="${comschedule.emp_code}" name="emp_code" readonly="readonly" style="width: 200px; background-color: white;">
                    </div>
                  </div>
