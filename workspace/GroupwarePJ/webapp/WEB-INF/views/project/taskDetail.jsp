...
<div id="content">
	<div class="card card-info">
		<div class="card-header">
			...
			<c:if test="${task.emp_kor eq authUser.emp_kor}">
				...
				<button class="btn btn-block bg-gradient-secondary btn-sm btnAction"
					id="btnUpdate" style="margin-top: 0px;" onclick="location.href='${cPath }/project/editTask/${task.task_code}/${task.project_code }'">
