...
public class PagingVO<T> {
	...
	public String getPagingHTML() {
		...
		StringBuffer html = new StringBuffer("<ul class='pagination mx-auto my-2'>");
		String liClass = startPage>blockSize?"":"disabled";
		html.append(
			String.format(blockPattern, liClass, startPage - blockSize, "&laquo;")
		);
		...
		html.append(
			String.format(blockPattern, liClass, endPage+1, "&raquo;")
		);
		html.append("</ul>");
