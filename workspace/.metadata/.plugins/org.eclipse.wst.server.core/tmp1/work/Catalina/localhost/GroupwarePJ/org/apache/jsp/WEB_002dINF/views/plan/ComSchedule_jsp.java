 ...
 * Generated at: 2020-08-18 12:19:07 UTC
...
public final class ComSchedule_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("               <option value=\"catag\" \r\n");
      out.write("               data-select2-id=\"3\">카테고리</option>\r\n");
      ...
      out.write("\t\t\t\tlet comscheduleList = resp.dataList;\r\n");
      out.write("\t\t\t\tlet pagingHTML = resp.pagingHTML;\r\n");
      out.write("\t\t\t\tlet trTags = [];\r\n");
      out.write("\t\t\t\tif(comscheduleList.length>0){\r\n");
      out.write("\t\t\t\t\t$.each(comscheduleList, function(idx, comschedule){\r\n");
      out.write("\t\t\t\t\t\tlet trTag = $(\"<tr>\").append(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$(\"<td>\").html('<input type=\"checkbox\" name=\"checkRow\" value=\"'+comschedule.cs_code+'\" />')\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").text(comschedule.cs_catag)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").html(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t$(\"<a>\").attr(\"href\", \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/plan/DetailComSchedule/\" + comschedule.cs_code)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t.text(comschedule.cs_title)\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").text(comschedule.emp_code)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").text(comschedule.cs_startdate)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").text(comschedule.cs_enddate)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").text(comschedule.cs_important)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t);\r\n");
      out.write("\t\t\t\t\t\ttrTags.push(trTag);\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t$(\"#pagingArea\").html(pagingHTML);\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\ttrTags.push($(\"<tr>\").html($(\"<td colspan='8'>\").text(\"조건에 맞는 회사일정이 없음.\")));\r\n");
      ...
      out.write("\t            url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/plan/companyplan/deletecom',\r\n");
      out.write("\t            type : \"POST\",\r\n");
      out.write("\t            datatype : 'json',\r\n");
      out.write("\t            contentType: \"application/x-www-form-urlencoded; charset=UTF-8\", \r\n");
      out.write("\t            data:{\r\n");
      out.write("\t                cs_code : checkRow\r\n");
      out.write("\t            },\r\n");
