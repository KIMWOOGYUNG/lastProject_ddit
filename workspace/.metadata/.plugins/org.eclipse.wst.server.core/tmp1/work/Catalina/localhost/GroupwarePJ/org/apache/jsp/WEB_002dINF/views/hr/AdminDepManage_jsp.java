 ...
 * Generated at: 2020-08-11 02:53:39 UTC
...
public final class AdminDepManage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\th2{margin:10px 0 0 0;}\r\n");
      ...
      out.write("         \t\t<table id=\"example2\" class=\"table table-hover dataTable dtr-inline\" role=\"grid\" aria-describedby=\"example2_info\">\r\n");
      out.write("\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t   <tr>\r\n");
      out.write("\t\t\t\t\t\t   <th rowspan=\"1\" colspan=\"1\">선택</th>\r\n");
      out.write("\t\t\t\t\t\t   <th rowspan=\"1\" colspan=\"1\">부서코드</th>\r\n");
      out.write("\t\t\t\t\t\t   <th rowspan=\"1\" colspan=\"1\">부서명</th>\r\n");
      out.write("\t\t\t\t\t\t   </tr>\r\n");
      out.write("\t\t\t\t    </thead>\r\n");
      out.write("                 \t<tbody id=\"listBody\"></tbody>\r\n");
      out.write("                 </table>\r\n");
      out.write("                 </div>\r\n");
      ...
      out.write("\t\t\t\tlet depList = resp.dataList;\r\n");
      out.write("\t\t\t\tlet pagingHTML = resp.pagingHTML;\r\n");
      out.write("\t\t\t\tlet trTags = [];\r\n");
      out.write("\t\t\t\tif(depList.length>0){\r\n");
      out.write("\t\t\t\t\t$.each(depList, function(idx, depmanage){\r\n");
      out.write("\t\t\t\t\t\tlet trTag = $(\"<tr>\").append(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$(\"<td>\").html('<input type=\"checkbox\" name=\"checkRow\" value=\"'+depmanage.dept_code+'\" />')\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").text(depmanage.dept_code)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").text(depmanage.dept_name)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t);\r\n");
      out.write("\t\t\t\t\t\ttrTags.push(trTag);\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t$(\"#pagingArea\").html(pagingHTML);\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\ttrTags.push($(\"<tr>\").html($(\"<td colspan='8'>\").text(\"조건에 맞는 부서가 없음.\")));\r\n");
      ...
      out.write("\t    alert(\"삭제할 부서를 선택하세요.\");\r\n");
      out.write("\t    return false;\r\n");
      out.write("\t  }\r\n");
      out.write("\t  console.log(\"### checkRow => {}\"+checkRow);\r\n");
      out.write("\t \r\n");
      out.write("\t  if(confirm(\"부서를 삭제 하시겠습니까?\")){\r\n");
      out.write("\t\t  $.ajax({\r\n");
      out.write("\t            url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/hr/employer/deletedept',\r\n");
      out.write("\t            type : \"POST\",\r\n");
      out.write("\t            datatype : 'json',\r\n");
      out.write("\t            contentType: \"application/x-www-form-urlencoded; charset=UTF-8\", \r\n");
      out.write("\t            data:{\r\n");
      out.write("\t                dept_code : checkRow\r\n");
      out.write("\t            },\r\n");
