...
<div id="nav">
  ...
  <div class="card-body table-responsive p-0">
     <div style="margin:20px 20px 0px 20px;">
				<button class="button showBtn" id="blockBtn" data-target="#blockBody" onclick = "location.href = '${cPath}/plan/depplancalendar/all' ">
...
<form id="searchForm" action="${pageContext.request.contextPath }/plan/departmentplanbox/departmentplan">
				...
				if(deptscheduleList.length>0){
					$.each(deptscheduleList, function(idx, deptschedule){
						let trTag = $("<tr>").append(
										...
										, $("<td>").html(
											$("<a>").attr("href", "${pageContext.request.contextPath}/plan/detaildepplan/" + deptschedule.ds_code)
