...
<div class="content">
              ...
              <form class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="hidden" class="form-control" id="writer" value="${authUser.emp_code}" name="writer">
                      <p class="form-control" style="margin: 0; width: 200px;">${authUser.emp_kor}</p>
                    </div>
                  </div>
			...
			<div class="form-group row">
				...
				<input type="text" class="emp_kor"  id="emp_kors" name="" value="${manager.emp_code }" style="height: 35px; width: 200px; border: 1px solid #ced4da; border-radius: .25rem;">
				<!-- 주소록 버튼 -->
