...
<div id="nav">
	...
	<a class="btn btn-primary btn-sm" href="${cPath}/plan/companyplan/complanenroll">
...
<div class="card-body table-responsive p-0">
	<div style="margin:20px 20px 0px 20px;">
					<button class="button showBtn" id="blockBtn" data-target="#blockBody" onclick = "location.href = '${cPath}/plan/complancalendar' ">
				...
				if(comscheduleList.length>0){
					$.each(comscheduleList, function(idx, comschedule){
						let trTag = $("<tr>").append(
										...
										, $("<td>").html(
											$("<a>").attr("href", "${pageContext.request.contextPath}/plan/DetailComSchedule/" + comschedule.cs_code)
...
//체크된것 삭제(체크박스된 것 전부)
	function deleteAction(){
	  ...
	  if(confirm("일정을 삭제 하시겠습니까?")){
		  $.ajax({
	            url : '${pageContext.request.contextPath }/plan/companyplan/deletecom',
	            type : "POST",
	            datatype : 'json',
	            ...
	            success : function(data) {
				    alert("삭제가 완료되었습니다.");
				    location.href="${pageContext.request.contextPath }/plan/companyplan";
