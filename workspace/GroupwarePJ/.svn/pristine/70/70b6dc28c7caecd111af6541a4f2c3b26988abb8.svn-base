...
<style>
	...
	#img2, #img3{margin-left:8px;}
	.selectFile{margin-left:17%;}
	.selectFile1{margin-left:4%;}
</style>
...
<div id="content">
	...
	<div class="card card-primary">
		...
		<div class="card-footer" align="center">
			<img id="img1" src="${cPath }/resources/images/blank-profile-picture-973460_1280.png"
...
<!-- 			<button type="button" class="btn btn-info">첨부</button> -->
			...
			<br>
		<h5><b>이미지 미리보기</b></h5>
		<input type="file" id="input_img1" name="img1" class="selectFile1"/>
	</div>
	<div>
...
<!-- 				</div> -->
				...
				<div class="form-group row" >
					<label for="inputStatus" class="col-sm-2 col-form-label" >부서명</label>
					<div class="col-sm-10">
						<select id="dept_code" class="dynamicElement form-control select2bs4 select2-hidden-accessible"  aria-hidden="true"  style="width: 200px; display: inline;"
				...
				<div class="form-group row" >
					...
					<div class="col-sm-10">
						<select class="dynamicElement form-control select2bs4 select2-hidden-accessible"  aria-hidden="true"  style="width: 200px; display: inline;"
								id="team_code" name="team_code" data-url="<c:url value= '/employ/getTeamList'/>">
...
<!-- 				</div> -->
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select class="form-control" style="width: 200px;"
							name="position_code" id="position_code">
...
<!-- 							<option selected disabled >직책</option> -->
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select class="form-control" style="width: 200px;" id="power" name="emp_arbitrary" id="emp_arbitrary">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="emp_zip"
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control"
							...
							value="${employee.emp_reg1}" id="emp_reg1" name="emp_reg1"> - <input type="text"
							class="form-control"
							style="height: 35PX; width: 200PX; display: inline;"
							value="${employee.emp_reg2}" id="emp_reg2" name="emp_reg2">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div style="width:80%">
					<img id="img2"
					class="img-fluid mb-2" alt="" style="height: 100px; width: 100px;">
					</div>
...
<!-- 				<button type="button" class="btn btn-info">도장 업로드</button> -->
				...
				<div class="form-group row">
					...
					<div style="width:80%">
						<img id="img3" class="img-fluid mb-2" alt="" style="height: 100px; width: 100px;">	
					</div>			
<!-- 				<button type="button" class="btn btn-info">사인 업로드</button>				 -->
			...
			<!-- /.card-body -->
			<div class="card-footer" align="center">
				<button type="button" class="btn btn-default float-right" id="cancel" onclick ="location.href ='${cPath}/hr/employer/entiremanage'">취소</button>
				<button type="submit" class="btn btn-primary float-right" id="enroll" onclick="enroll_click();" style="margin-right:10px;">등록</button>
				<button type="button" class="btn btn-primary float-right" id="enroll" onclick="add_info();" style="margin-right:10px;">입력</button>
			</div>
			<!-- /.card-footer -->
...
function add_info(){
	$("#emp_kor").val("강현진");
	$("#emp_eng").val("KANGHYEONJIN");
	$("#emp_pw").val("1234");
	$("#dept_code").val("DE002").prop("selected", true);
	$("#team_code").val("TE004").prop("selected", true);
	$("#position_code").val("PO001").prop("selected", true);
	$("#active").val("y").prop("selected", true);
	$("#emp_arbitrary").val("n").prop("selected", true);
	$("#innertel").val("042-555-7777");
	$("#emp_mail").val("naha@ddit.or.kr");
	$("#phonenumber").val("010-2222-4444")
	$("#emp_mail").val("naha@ddit.or.kr");
	$("#emp_zip").val("34303");
	$("#adr2").val("부산 해운대구 APEC로 17");
	$("#emp_add2").val("스마트시티 1001동 1001호");
	$("#emp_reg1").val("960800");
	$("#emp_reg2").val("1400000");
	$("#emp_sal").val("3000");
	$("#emp_ip").val("168.192.40.23");
	$("#emp_startdate").val("2020-08-19");
	$("#vacation_cnt").val("12");
}
	...
	$(document).on("keyup","#phonenumber",function() {
						$(this).val($(this).val().replace(/[^0-9]/g, "").replace(/(^02|^0505|^1[0-9]{3}|^0[0-9]{2})([0-9]+)?([0-9]{4})$/,
														"$1-$2-$3").replace(
														"--", "-"));
					});
...
function enroll_click() {
	if(confirm(${emp_pk}+"(으)로 사원계정을 등록하시겠습니까?") == true){
		...
		location.href='${cPath}/hr/employer/entiremanage';
	}
}
</script>
