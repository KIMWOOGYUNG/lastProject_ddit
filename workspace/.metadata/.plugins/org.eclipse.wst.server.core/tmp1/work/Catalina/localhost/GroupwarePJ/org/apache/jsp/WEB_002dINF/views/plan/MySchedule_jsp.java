 ...
 * Generated at: 2020-08-18 12:21:00 UTC
...
public final class MySchedule_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\tlet myscheduleList = resp.dataList;\r\n");
      out.write("\t\t\t\tlet pagingHTML = resp.pagingHTML;\r\n");
      out.write("\t\t\t\tlet trTags = [];\r\n");
      out.write("\t\t\t\tif(myscheduleList.length>0){\r\n");
      out.write("\t\t\t\t\t$.each(myscheduleList, function(idx, myschedule){\r\n");
      out.write("\t\t\t\t\t\tlet trTag = $(\"<tr>\").append(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$(\"<td>\").html('<input type=\"checkbox\" name=\"checkRow\" value=\"'+myschedule.ms_code+'\" />')\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").html(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t$(\"<a>\").attr(\"href\", \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/plan/DetailMySchedule/\" + myschedule.ms_code)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t.text(myschedule.ms_title)\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").text(myschedule.emp_code)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").text(myschedule.ms_startdate)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").text(myschedule.ms_enddate)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t, $(\"<td>\").text(myschedule.ms_important)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t);\r\n");
      out.write("\t\t\t\t\t\ttrTags.push(trTag);\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t$(\"#pagingArea\").html(pagingHTML);\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\ttrTags.push($(\"<tr>\").html($(\"<td colspan='8'>\").text(\"조건에 맞는 내 일정이 없음.\")));\r\n");
      ...
      out.write("\t            url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/plan/myplanbox/myplan/deletemy',\r\n");
      out.write("\t            type : \"POST\",\r\n");
      out.write("\t            datatype : 'json',\r\n");
      out.write("\t            contentType: \"application/x-www-form-urlencoded; charset=UTF-8\", \r\n");
      out.write("\t            data:{\r\n");
      out.write("\t                ms_code : checkRow\r\n");
      out.write("\t            },\r\n");
